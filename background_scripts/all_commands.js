...
const allCommands = [
...

  {
    ...
    optionSchema: { hard: { type: "boolean" } },
  },
  ...
  // BrowserToolbox 新命令与 Vimium 命令共用注册表，避免设置、帮助和输入绑定各维护一份清单。
  {
    name: "BrowserToolbox.closeWindow",
  ...
  {
    name: "BrowserToolbox.toggleFullscreen",
  ...
  {
    name: "BrowserToolbox.minimizeWindow",
  ...
  {
    name: "BrowserToolbox.maximizeWindow",
  ...
  {
    name: "BrowserToolbox.showTabList",
    desc: "Show tab list",
    group: "tabs",
    background: true,
    noRepeat: true,
  ...
  {
    name: "BrowserToolbox.toggleMouseGestures",
    desc: "Toggle mouse gestures",
    group: "settings",
    background: true,
    noRepeat: true,
  },
  {
    name: "BrowserToolbox.toggleSuperDrag",
    desc: "Toggle super drag",
    group: "settings",
    background: true,
    noRepeat: true,
  },
  {
    name: "BrowserToolbox.copySelection",
    desc: "Copy selected text",
    group: "links",
    noRepeat: true,
    supportedInputs: ["superDrag"],
    requiredContext: ["selection"],
  },
  {
    name: "BrowserToolbox.copyLinkText",
    desc: "Copy link text",
    group: "links",
    noRepeat: true,
    supportedInputs: ["superDrag"],
    requiredContext: ["link"],
  },
  {
    name: "BrowserToolbox.copyLinkUrl",
    desc: "Copy link URL",
    group: "links",
    noRepeat: true,
    supportedInputs: ["superDrag"],
  ...
  {
    name: "BrowserToolbox.copyImageUrl",
    desc: "Copy image URL",
    group: "links",
    noRepeat: true,
    supportedInputs: ["superDrag"],
  ...
  {
    name: "BrowserToolbox.searchSelection",
  ...
  {
    name: "BrowserToolbox.openLinkForeground",
    desc: "Open link in foreground",
    group: "links",
    background: true,
    noRepeat: true,
    supportedInputs: ["superDrag"],
  ...
  {
    name: "BrowserToolbox.openLinkBackground",
    desc: "Open link in background",
    group: "links",
    background: true,
    noRepeat: true,
    supportedInputs: ["superDrag"],
  ...
  {
    name: "BrowserToolbox.openImageForeground",
    desc: "Open image in foreground",
    group: "links",
    background: true,
    noRepeat: true,
    supportedInputs: ["superDrag"],
  ...
  {
    name: "BrowserToolbox.openImageBackground",
    desc: "Open image in background",
    group: "links",
    background: true,
    noRepeat: true,
    supportedInputs: ["superDrag"],
  ...
  {
    name: "BrowserToolbox.downloadImage",
    desc: "Download image",
    group: "links",
    noRepeat: true,
    supportedInputs: ["superDrag"],
