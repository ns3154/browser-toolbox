...
const allCommands = [
  ...
  // OpenKeyMouse 新命令与 Vimium 命令共用注册表，避免设置、帮助和输入绑定各维护一份清单。
  {
    name: "OpenKeyMouse.closeWindow",
  ...
  {
    name: "OpenKeyMouse.toggleFullscreen",
  ...
  {
    name: "OpenKeyMouse.minimizeWindow",
  ...
  {
    name: "OpenKeyMouse.maximizeWindow",
  ...
  {
    name: "OpenKeyMouse.toggleMouseGestures",
  ...
  {
    name: "OpenKeyMouse.toggleSuperDrag",
  ...
  {
    name: "OpenKeyMouse.copySelection",
    desc: "Copy selected text",
    group: "links",
    noRepeat: true,
  },
  {
    name: "OpenKeyMouse.copyLinkText",
    desc: "Copy link text",
    group: "links",
    noRepeat: true,
  },
  {
    name: "OpenKeyMouse.copyLinkUrl",
    desc: "Copy link URL",
    group: "links",
    noRepeat: true,
  },
  {
    name: "OpenKeyMouse.copyImageUrl",
    desc: "Copy image URL",
    group: "links",
    noRepeat: true,
  },
  {
    name: "OpenKeyMouse.searchSelection",
  ...
  {
    name: "OpenKeyMouse.openLinkForeground",
  ...
  {
    name: "OpenKeyMouse.openLinkBackground",
  ...
  {
    name: "OpenKeyMouse.openImageForeground",
  ...
  {
    name: "OpenKeyMouse.openImageBackground",
  ...
  {
    name: "OpenKeyMouse.downloadImage",
    desc: "Download image",
    group: "links",
    noRepeat: true,
  },
