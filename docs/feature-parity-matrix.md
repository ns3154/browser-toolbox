...
| O-001 | OpenKeyMouse | 统一 CommandInvocation / Dispatcher     | 本项目设计文档 | 全部新增输入        | PASS     | PENDING  | IN_PROGRESS | Super Drag/Wheel/Rocker 代表消息已实测；完整输入矩阵待测 |
| O-002 | OpenKeyMouse | 四向/八向右键轨迹                       | 本项目设计文档 | mouse bindings      | PASS     | PENDING  | IN_PROGRESS | 算法单测已覆盖                                           |
| O-003 | OpenKeyMouse | 安全超级拖拽                            | 本项目设计文档 | OpenKeyMouse.*      | PASS     | PENDING  | IN_PROGRESS | LINK 前台打开 E2E 已通过；其他上下文和绑定待测           |
| O-004 | OpenKeyMouse | 滚轮组合与摇杆                          | 本项目设计文档 | wheel / rocker      | PASS     | PENDING  | IN_PROGRESS | Wheel 右键上滚、Rocker 右按左点 E2E 已通过；其余待测     |
...
| C-003 | CrxMouse     | 超级拖拽                                | 公开功能描述   | OpenKeyMouse.*      | PASS     | PENDING  | IN_PROGRESS | LINK 代表链路已实测；不复制闭源代码、资产、文案或界面    |
