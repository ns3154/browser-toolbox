...
// settingsVersion 记录的是 Vimium 设置迁移兼容版本，与 BrowserToolbox 预发布版本号分开。
const vimiumSettingsVersion = "2.4.2";
...
const Settings = {
  ...
  async load() {
    ...
    result["settingsVersion"] = vimiumSettingsVersion;
  ...
  async setSettings(settings) {
    ...
    settings["settingsVersion"] = vimiumSettingsVersion;
