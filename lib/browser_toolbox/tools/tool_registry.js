...
(function () {
  ...
  const descriptors = [
    ...
    },
    {
      ...
      categoryId: "developer",
      route: "config",
      titleKey: "toolConfigConvert",
      descriptionKey: "toolConfigConvertDescription",
      category: "format",
      keywordKeys: ["toolKeywordProperties", "toolKeywordYaml", "toolKeywordConfig"],
      icon: "braces",
      surfaces: { catalog: true, popup: true, contextMenu: true, settings: true },
      executionContexts: ["extension-page"],
      inputMode: "single",
      localOnly: true,
      capabilities: ["convert", "copy", "download"],
    ...
    },
    {
      ...
      category: "codec",
      keywordKeys: ["toolKeywordCodec", "toolKeywordBase64"],
      icon: "code",
      surfaces: { catalog: true, popup: true, contextMenu: true, settings: true },
      executionContexts: ["extension-page"],
      inputMode: "single",
      ...
      controls: [{ key: "mode", labelKey: "toolMode", type: "select", defaultValue: "base64Encode", options: [
        ...
        ["uriEncode", "toolUriEncode"], ["uriDecode", "toolUriDecode"],
        ["unicodeEscapeEncode", "toolUnicodeEscapeEncode"], ["unicodeEscapeDecode", "toolUnicodeEscapeDecode"],
        ["jsonStringEncode", "toolJsonStringEncode"], ["jsonStringDecode", "toolJsonStringDecode"],
        ["xmlEncode", "toolXmlEncode"], ["xmlDecode", "toolXmlDecode"],
        ["binaryEncode", "toolBinaryEncode"], ["binaryDecode", "toolBinaryDecode"],
        ["octalEncode", "toolOctalEncode"], ["octalDecode", "toolOctalDecode"],
        ["decimalEncode", "toolDecimalEncode"], ["decimalDecode", "toolDecimalDecode"],
        ["asciiEncode", "toolAsciiEncode"], ["asciiDecode", "toolAsciiDecode"],
        ["dataUrlEncode", "toolDataUrlEncode"], ["dataUrlDecode", "toolDataUrlDecode"],
        ["md5", "toolMd5"],
      ] }],
    },
    {
  ...
  // 默认固定项独立于目录顺序，新增工具不会替换既有快捷入口。
  const DEFAULT_ACTION_TOOL_IDS = Object.freeze([
    "json.format", "text.diff", "codec.transform", "time.convert", "id.generate", "password.generate",
  ]);
  const DEFAULT_CONTEXT_MENU_TOOL_IDS = Object.freeze(["json.format", "text.diff", "codec.transform"]);
