 ...
 * @property {Object} siteRules[].profile 站点配置档，可覆盖输入模块的局部设置。
...
(function () {
  ...
  const DEFAULT_CONTEXT_MENU_TOOL_IDS = toolRegistry?.DEFAULT_CONTEXT_MENU_TOOL_IDS || [
    "json.format",
    "text.diff",
    "codec.transform",
  ];
  ...
  // 配置档只包含本地静态预设；用户选择后会复制到对应站点规则中，运行时不会加载远程配置。
  const SITE_PROFILE_PRESETS = Object.freeze({
    balanced: Object.freeze({
      labelKey: "siteProfileBalanced",
      descriptionKey: "siteProfileBalancedDescription",
      profile: Object.freeze({
        ...
        superDrag: Object.freeze({ enabled: true, nativeBypassModifier: "Alt" }),
        wheel: Object.freeze({ enabled: true, threshold: 80, cooldownMs: 180 }),
        rocker: Object.freeze({ enabled: true }),
      }),
    }),
    editor: Object.freeze({
      labelKey: "siteProfileEditor",
      descriptionKey: "siteProfileEditorDescription",
      profile: Object.freeze({
        preset: "editor",
        mouse: Object.freeze({
          enabled: false,
          activationDistancePx: 18,
          minimumSegmentDistancePx: 24,
          showTrail: false,
          showCommandHud: false,
        }),
        superDrag: Object.freeze({ enabled: false, nativeBypassModifier: "Alt" }),
        wheel: Object.freeze({ enabled: false, threshold: 120, cooldownMs: 220 }),
        rocker: Object.freeze({ enabled: false }),
      }),
    }),
    reading: Object.freeze({
      labelKey: "siteProfileReading",
      descriptionKey: "siteProfileReadingDescription",
      profile: Object.freeze({
        preset: "reading",
        mouse: Object.freeze({
          enabled: true,
          activationDistancePx: 14,
          minimumSegmentDistancePx: 24,
          showTrail: false,
          showCommandHud: true,
        }),
        superDrag: Object.freeze({ enabled: true, nativeBypassModifier: "Alt" }),
        wheel: Object.freeze({ enabled: true, threshold: 120, cooldownMs: 220 }),
        rocker: Object.freeze({ enabled: true }),
      }),
    }),
  });
  ...
  const defaultSettings = {
    ...
    mouse: {
      ...
      bindings: [
        ...
        },
        {
          ...
          enabled: true,
          pattern: ["D"],
          commandName: "scrollFullPageDown",
          options: {},
        },
        {
          id: "mouse-close-tab",
        ...
        {
          id: "mouse-open-settings",
          enabled: true,
          pattern: ["R", "D", "L", "U"],
          commandName: "BrowserToolbox.openSettings",
          options: {},
        },
      ],
    },
    ...
    tools: {
      enabled: true,
      pinnedIds: DEFAULT_ACTION_TOOL_IDS,
      contextMenu: {
        enabled: true,
        toolIds: DEFAULT_CONTEXT_MENU_TOOL_IDS,
      },
      documentFormatter: {
        enabled: true,
        autoFormat: {
        ...
        maxAutoBytes: 5 * 1024 * 1024,
        json: {
          defaultSort: "original",
          defaultCollapseDepth: null,
        },
      },
    },
  };
  ...
  globalThis.BrowserToolboxSettingsSchema = Object.freeze({
    ...
    SUPPORTED_LANGUAGES: Object.freeze(["auto", "en", "zh_CN", "zh_TW", "ja", "es"]),
    DEFAULT_SETTINGS: defaultSettings,
    DEFAULT_SITE_RULES,
    SITE_PROFILE_PRESETS,
    DEFAULT_ACTION_TOOL_IDS: Object.freeze(DEFAULT_ACTION_TOOL_IDS.slice()),
    DEFAULT_CONTEXT_MENU_TOOL_IDS: Object.freeze(DEFAULT_CONTEXT_MENU_TOOL_IDS.slice()),
    clone,
    mergeSettings,
  });
})();
