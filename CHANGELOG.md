## OpenKeyMouse 0.1.0（预发布，未完成最终兼容性验收）
...
- 项目永久免费、无广告、无账户、无订阅、无付费功能、无遥测、无远程代码，不复制 CrxMouse 闭源代码、资产、
  文案或界面。
- Windows、Edge、Chrome Stable 人工矩阵、认证态真实站点、屏幕阅读器和完整 Vimium 手工回归仍待实际验证，
  不应据此条目宣称最终发布完成。
