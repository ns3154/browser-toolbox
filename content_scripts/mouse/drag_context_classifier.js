...
(function () {
  ...
  function classify(target, selectedText = "", dataTransfer = null) {
    ...
    const link = closest(target, "a[href], area[href]");
    if (link) {
    ...
    if (closest(target, "[draggable='true']")) {
    ...
    if (text && !closest(target, "input, textarea, [contenteditable]")) {
